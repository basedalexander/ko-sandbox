...
intellisense.annotate(jQuery.fn, {
  ...
  'on': function() {
    ...
    ///   <param name="data" type="Anything">json to be passed to the handler in event.data when an event is triggered.</param>
    ...
    ///   <param name="data" type="Anything">json to be passed to the handler in event.data when an event occurs.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'one': function() {
